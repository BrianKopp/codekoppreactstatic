...
export function initGoogleMap() {
    ...
    if (!document.getElementById('g-map')) {
        ...
        // const latitude = document.getElementById('g-map').getAttribute('data-latitude');
        // const longitude = document.getElementById('g-map').getAttribute('data-longitude');
        // var mapStyles = [
